...
public class DomainEventTests
{
    ...
    public void Create_ShouldSetOccurredOn_ToApproximatelyNow()
    {
        ...
        var evt = DomainEvent.Create("id", "Type", "EventType", "{}", 0);
    ...
    {
        var e1 = DomainEvent.Create("id", "Type", "Event", "{}", 0);
        var e2 = DomainEvent.Create("id", "Type", "Event", "{}", 0);
    ...
    {
        var ex = Assert.Throws<ArgumentException>(() =>
            DomainEvent.Create("id", aggregateType!, "EventType", "{}", 0));
