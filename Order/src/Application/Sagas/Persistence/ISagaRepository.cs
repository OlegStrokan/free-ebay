...
public interface ISagaRepository
{
    ...
    Task<SagaState?> GetByCorrelationIdAsync(Guid correlationId, string sagaType, CancellationToken cancellationToken);
    Task SaveAsync(SagaState sagaState, CancellationToken cancellationToken);
    Task SaveStepAsync(SagaStepLog stepLog, CancellationToken cancellationToken);
