...
[TestFixture]
public class InventoryReleasedConsumerTests
{
    private ISender _sender = null!;
    private ILogger<InventoryReleasedConsumer> _logger = null!;
    private InventoryReleasedConsumer _consumer = null!;

    [SetUp]
    public void SetUp()
    {
        _sender = Substitute.For<ISender>();
        _logger = Substitute.For<ILogger<InventoryReleasedConsumer>>();
        _consumer = new InventoryReleasedConsumer(_sender, _logger);
    ...
    [Test]
    public void EventType_ShouldBeInventoryReleased()
    {
        Assert.That(_consumer.EventType, Is.EqualTo("InventoryReleased"));
    }
