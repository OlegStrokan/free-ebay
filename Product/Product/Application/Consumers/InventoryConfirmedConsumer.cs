...
public sealed class InventoryConfirmedConsumer(
    ISender sender,
    ILogger<InventoryConfirmedConsumer> logger) : IInventoryEventConsumer
{
    public string EventType => "InventoryConfirmed";
        ...
        foreach (var item in @event.Items)
        {
            ...
            if (!result.IsSuccess)
                ...
                logger.LogInformation(
                    "Stock decremented by {Qty} for product {ProductId} (reservation {ReservationId} confirmed)",
