...
import { ProceedPaymentDto } from './dtos/proceed-payment.dto';
...
export class CheckoutController {
  constructor(
    ...
    private initiatePaymentUseCase: IInitiatePaymentUseCase,
  ...
  @Post('payment')
  @ApiOperation({ summary: 'Proceed with payment' })
  @ApiBody({ type: ProceedPaymentDto })
  proceedPayment(@Body() dto: ProceedPaymentDto) {
